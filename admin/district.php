              ...
              <form method="post" action="" enctype="multipart/form-data" onsubmit="return check_add_district(this)">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Taluka Name" name="district_name">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Taluka Status</label>
