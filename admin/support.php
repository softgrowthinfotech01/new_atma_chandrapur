   ...
   <div class="accordion-item">
    ...
    <div id="flush-collapseadd" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
                  Click On <b>Taluka</b>  from menu > Add Taluka name like e.g Chandrapur , Rajura >click Submit
              </li>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">
          <ul>
              <li>
                  Click On <b>User</b>  from menu > Enter the data Taluka, User name , user email , password , phone number , image .>click Submit
              </li>
