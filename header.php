...
<header class="site-header mo-left header fullwidth" style="align-content:center;">
  ...
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-light shadow bg-success bg-opacity-75">
    <div class="container">
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#mainNavbar"
        aria-controls="mainNavbar" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <h5 class="fw-bold mb-4 text-success navbar-toggler border-0 w-75 mx-auto text-start">
        <div class="text-center">
          कृषि तंत्रज्ञान व्यवस्थापन यंत्रणा ( आत्मा ) चंद्रपूर
        </div>
      </h5>
      <div class="collapse navbar-collapse" id="mainNavbar">
        <ul class="navbar-nav uul mx-auto gap-4 text-center ">

          <li class="nav-item"><a class="nav-link" href="home"> <b>मुख्य पृष्ठ </b></a></li>

          <li class="nav-item dropdown active ">
            <a class="nav-link dropdown-toggle text-dark fw-semibold px-2" href="#" id="aboutDropdown" role="button"
              data-bs-toggle="dropdown" aria-expanded="false">आमच्या विषयी</a>
          ...
          <li class="nav-item dropdown active">
            <a class="nav-link dropdown-toggle text-dark fw-semibold px-2" href="#" id="yojanaDropdown" role="button"
              data-bs-toggle="dropdown" aria-expanded="false">योजना</a>
            <ul class="dropdown-menu the" aria-labelledby="yojanaDropdown">
              <li><a class="dropdown-item drop" href="scheme_info">माहिती</a></li>
            </ul>
          </li>

          <li class="nav-item drop"><a class="nav-link text-dark fw-semibold px-2" href="news">बातम्या आणि घडामोडी</a>
          </li>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-dark fw-semibold px-2" href="#" id="galleryDropdown" role="button"
              data-bs-toggle="dropdown" aria-expanded="false">गॅलरी</a>
            <ul class="dropdown-menu the" aria-labelledby="galleryDropdown">
              ...
              <li><a class="dropdown-item drop" href="newspaper_cutout">वृत्तपत्र कात्रण</a></li>
              <li><a class="dropdown-item drop" href="krushi_song">कृषिगीत</a></li>
            </ul>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-dark fw-semibold px-2" href="#" id="kattDropdown" role="button"
              data-bs-toggle="dropdown" aria-expanded="false">शेतकरी कट्टा</a>
            <ul class="dropdown-menu the" aria-labelledby="kattDropdown">
              ...
              <li><a class="dropdown-item drop" href="talukas">तालुका ब्लॉग</a></li>
            </ul>
          </li>
