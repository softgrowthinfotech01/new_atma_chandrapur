...
{
    echo '<script>alert("Taluka Id not found.");window.location.href = "talukas";</script>';
}
?>
<style>
    .blog-layout
...
<?php include_once "header.php";?>
    ...
    <!-- /.stricky-header -->
        ...
        <section class="page-header p-0 ">
            ...
            <!--</div>-->
            <div class="container">
                <div class="page-header__inner pb-4">
                    <ul class="thm-breadcrumb list-unstyled d-flex ">
...
<div class="card  mx-auto">
    ...
    <div class="category"> <i class="fas fa-user-circle px-1"></i><?php echo $row_district[0]['district_name'];?> | <i class="fas fa-comments px-1"></i><?php echo $row_category[0]['category_name'];?>  </div>
    <div class="heading"> <?php echo $r['blog_title'];?>
        <div class="author"> <span class="name"><?php echo date('d',strtotime($r['added_on']));?></span>
                                    <p><?php echo date('M',strtotime($r['added_on']));?></p></div>
    </div>
</div>
                    </div>
                    <?php
